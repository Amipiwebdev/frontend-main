...
// -------- icons (reused) --------
  ...
  const PhoneIcon = (props) => (
    <svg
      ...
      {...props}
    >
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.08 4.18 2 2 0 0 1 4.06 2h3a2 2 0 0 1 2 1.72c.12.86.32 1.7.59 2.5a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.58-1.11a2 2 0 0 1 2.11-.45c.8.27 1.64.47 2.5.59A2 2 0 0 1 22 16.92z" />
    </svg>
  );
    ...
    <header className="main-header">
      <nav className="navbar navbar-expand-lg abg-secondary p-0">
        <div className="container-fluid">
                    {/* MOBILE: left hamburger + center logo + right icons */}
          <button
          ...
          {/* MOBILE ICONS (search / phone / cart / user) */}
          <ul className="d-lg-none head-icon-list mb-0 ms-auto">
            ...
            <li>
              <a
                href="https://www.amipi.com/My-Cart/"
                className="head-icon-btn"
                title="Cart"
                aria-label="Cart"
              >
            ...
            <li className="position-relative">
              ...
              {/* Same login popup (works on mobile too) */}
              {!authUser && showLogin && (
                <div
                  ref={popRef}
          ...
          {/* Desktop toggler not needed; offcanvas is mobile only */}
