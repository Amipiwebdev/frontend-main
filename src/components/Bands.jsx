  ...
  return (
    <div>
      ...
      <div className="custom-container">
        <div className="row">
          <div className="main-content" style={{ display: "flex", gap: 40, position: "relative" }}>
            {/* GALLERY */}
            <div className="left-gallery-band col-8">
            ...
            {/* FILTERS */}
            <div className="right-filters col-4">
              {/* Stone Type */}
                  ...
                  <div className="product-details">
                    <div className="detail">
                      <div className="box-grey">
                        ...
                        <tbody>
                          <tr className="c_table_row_grey-box">
                            <td className="text-left" width="33%">
                            ...
                            <td className="text-right" width="33%">
                              <div className="d-flex hig-head">
                                <div className="col-size">
                      ...
                      <div className="d-flex c_flex_box">
                        ...
                        >
                          {/* All button functionality should be handled in React, not with onClick attributes! */}
                          <ul className="action product-d-action">
                            ...
                            <li
                              ...
                              className="wishlist-btn common-btn"
                            >
                            ...
                            <li
                              ...
                              className="wishlist-btn-active common-btn"
                            >
                              <i className="fa fa-heart" aria-hidden="true"></i>
                            </li>
                            <li
                              style={{ cursor: "pointer" }}
                              className="AddCompareButtClass-3004929 wishlist-btn common-btn"
                            ...
                            <li
                              ...
                              className="RemoveCompareButtClass-3004929 wishlist-btn-active common-btn"
                            ...
                            <li style={{ cursor: "pointer" }} className="hover-none">
                              <div className="band-cart-btn">
                                <div
                                  ...
                                  style={{ cursor: "pointer" }}
                                  // onClick={() => ...}  <-- React event here!
                                  title="Add To Cart"
                                >
                                  <i className="fa fa-shopping-cart" aria-hidden="true"></i> ADD TO CART                                </div>
                              </div>
                            </li>
                          </ul>
                        </div>
